<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="companyReportList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="id" align="center" prop="id" />
      <el-table-column label="公司名称" align="center" prop="companyName" />
      <el-table-column label="上市地区" align="center" prop="listingPlace" />
      <el-table-column label="上市时间" align="center" prop="ipoDate" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.ipoDate, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="报告状态" align="center" prop="reportStatus" show-overflow-tooltip/>
      <el-table-column label="报告内容" align="center" prop="report" show-overflow-tooltip />
      <el-table-column label="生成工具源" align="center" prop="generatorTool" show-overflow-tooltip />
      <el-table-column label="报告提示词" align="center" prop="reportPrompt" show-overflow-tooltip/>
      <el-table-column label="生成模型源" align="center" prop="generatorModel" show-overflow-tooltip/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="生成工具源" prop="generatorTool">
          <el-input v-model="form.generatorTool" placeholder="请输入生成工具源" />
        </el-form-item>
        <el-form-item label="报告提示词" prop="reportPrompt">
          <el-input v-model="form.reportPrompt" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="生成模型源" prop="generatorModel">
          <el-input v-model="form.generatorModel" placeholder="请输入生成模型源" />
        </el-form-item>
        <el-form-item label="原始总结" prop="originSummary">
          <el-input v-model="form.originSummary" type="textarea" placeholder="请输入内容" />
        </el-form-item>
      </el-form>
...
<script>
import { listCompanyReport, getCompanyReport, delCompanyReport, addCompanyReport, updateCompanyReport } from "@/api/system/companyReport"
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      listCompanyReport(this.queryParams).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除公司报告编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/companyReport/export', {
        ...this.queryParams
